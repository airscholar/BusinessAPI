defmodule BusinessapiWeb.BusinessController do
  use BusinessapiWeb, :controller

  alias Businessapi.Directory
  alias Businessapi.Directory.Business

  action_fallback BusinessapiWeb.FallbackController
